...
//				     DBStitchPerUserStoryDriver.configure(stitch_args);	
	                ...
	                String es_insert_input=stitch_output;
	             //   String es_insert_input="/storystitch/2017_05_02/";
	                ...
	                String [] esinsert_args = new String [] { es_insert_input,es_insert_output};
	                System.out.println("ES Args.. "+es_insert_input+","+es_insert_output);
